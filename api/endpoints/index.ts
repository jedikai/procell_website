...
export const endpoints = {
  ...
  app: {
    ...
    instagram_token:'web/get_instagram_token',
    ...
    practitioners_map: "web/practitioners_map",
    ...
    faq_list: "web/faqs",
    personal_referral: "web/rep",
    custom_referral: "web/referral",
    school_referral: "web/school",
    my_order_list: "web/portal/orders/page",
    story_section_data: "web/homepage_details",
    treatment_video_data: "web/testimonial_urls",
    ...
    // sales_list_serach: "web/portal/orders/search",
    sales_list_serach: "/web/portal/orders",
    ...
    mark_as_default_address: "web/address/default",
